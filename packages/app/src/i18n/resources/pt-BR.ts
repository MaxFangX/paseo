  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        emptyStaged: "Nenhuma alteração em stage",
        emptyUnstaged: "Nenhuma alteração fora do stage",
        ...
        staged: "Em stage",
        unstaged: "Fora do stage",
        stagedDescription: "Alterações preparadas para commit (git diff --staged)",
        unstagedDescription: "Alterações rastreadas ainda fora do stage (git diff)",
