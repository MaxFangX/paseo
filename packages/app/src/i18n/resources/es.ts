  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        emptyStaged: "Sin cambios preparados",
        emptyUnstaged: "Sin cambios sin preparar",
        ...
        stagedDescription: "Cambios preparados para confirmar (git diff --staged)",
        unstagedDescription: "Cambios rastreados aún sin preparar (git diff)",
