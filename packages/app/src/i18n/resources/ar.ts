  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        emptyStaged: "لا توجد تغييرات مجهزة",
        emptyUnstaged: "لا توجد تغييرات غير مجهزة",
        ...
        staged: "مجهز",
        unstaged: "غير مجهز",
        stagedDescription: "التغييرات المجهزة للالتزام (git diff --staged)",
        unstagedDescription: "التغييرات المتعقَّبة غير المجهزة بعد (git diff)",
        branchUnknown: "مجهول",
        base: "قاعدة",
        newFile: "جديد",
