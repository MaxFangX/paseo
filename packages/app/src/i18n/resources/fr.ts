  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        emptyStaged: "Aucune modification indexée",
        emptyUnstaged: "Aucune modification non indexée",
        ...
        staged: "Indexé",
        unstaged: "Non indexé",
        stagedDescription: "Modifications indexées pour la validation (git diff --staged)",
        unstagedDescription: "Modifications suivies pas encore indexées (git diff)",
