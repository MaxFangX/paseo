  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        // FORK(checkoutStagedModes): staged/unstaged diff view strings.
        ...
        committed: "Committed",
        // FORK(checkoutStagedModes): staged/unstaged dropdown labels.
        staged: "Staged",
        unstaged: "Unstaged",
        stagedDescription: "Changes staged for commit (git diff --staged)",
        unstagedDescription: "Tracked changes not yet staged (git diff)",
