  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        emptyStaged: "Нет индексированных изменений",
        emptyUnstaged: "Нет неиндексированных изменений",
        ...
        unstaged: "Неиндексировано",
        stagedDescription: "Изменения, подготовленные к коммиту (git diff --staged)",
        unstagedDescription: "Отслеживаемые изменения, ещё не индексированные (git diff)",
